...
def get_flights() -> list[str]:
    """Fetches the names of all available flights from Firestore."""
    return get_firestore_data("dummyData/flights/list?mask.fieldPaths=_id_only_")
