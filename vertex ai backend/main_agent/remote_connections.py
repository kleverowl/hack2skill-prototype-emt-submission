...
class RemoteConnections:
    ...
    async def invoke_agent(self, agent_url: str, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # full_agent_card_url = f"{agent_url}/.well-known/agent.json"
            # client = A2AClient(self.httpx_client, url=full_agent_card_url)
            client = A2AClient(self.httpx_client, url=agent_url)
