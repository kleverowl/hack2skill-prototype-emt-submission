...
# Update the import path below to the correct location of get_client_from_agent_card_url in your a2a package.
# For example, if it's in a2a.client, use:
# from a2a.client import get_client_from_agent_card_url

from a2a.client.http_client import get_client_from_agent_card_url  # <-- Update this line if needed
...
# Configuration
AGENT_URL = os.getenv("HOST_AGENT_A2A_URL", "http://localhost:8000")
...
async def create_a2a_client() -> A2AClient | None:
    ...
    try:
        ...
        client = await get_client_from_agent_card_url(httpx_client, AGENT_URL)
